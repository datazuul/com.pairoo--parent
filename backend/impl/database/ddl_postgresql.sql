...
drop table APPEARANCE_APPEARANCESTYLES cascade;
drop table BANKACCOUNT cascade;
drop table BLOCKEDUSER cascade;
drop table CONTACTEVENT cascade;
drop table CREDITCARDACCOUNT cascade;
drop table FAVORITE cascade;
drop table GEOAREA cascade;
drop table GEOLOCATION cascade;
drop table IMAGEENTRY cascade;
drop table LANDINGPAGEACTION cascade;
drop table LIFESTYLE cascade;
drop table LIFESTYLE_FOODTYPES cascade;
drop table LIFESTYLE_HOBBYTYPES cascade;
drop table LIFESTYLE_HOLIDAYTYPES cascade;
drop table LIFESTYLE_KITCHENTYPES cascade;
drop table LIFESTYLE_MUSICTYPES cascade;
drop table LIFESTYLE_PETTYPES cascade;
drop table LIFESTYLE_SPORTTYPES cascade;
drop table MEMBERSHIP cascade;
drop table MESSAGE cascade;
drop table NOTIFICATIONSETTINGS cascade;
drop table PAYMENTCHANNELS cascade;
drop table PAYONETRANSACTION cascade;
drop table PERSONALVALUES cascade;
drop table PRODUCT cascade;
drop table PROMOTION cascade;
drop table SEARCHPROFILE cascade;
drop table SEARCHPROFILE_APPEARANCESTYLES cascade;
drop table SEARCHPROFILE_BODYTYPES cascade;
drop table SEARCHPROFILE_EDUCATIONTYPES cascade;
drop table SEARCHPROFILE_ETHNICITIES cascade;
drop table SEARCHPROFILE_EYECOLORS cascade;
drop table SEARCHPROFILE_FAMILYSTATUSTYPES cascade;
drop table SEARCHPROFILE_HAIRCOLORS cascade;
drop table SEARCHPROFILE_HOBBYTYPES cascade;
drop table SEARCHPROFILE_LANGUAGES cascade;
drop table SEARCHPROFILE_RELIGIONS cascade;
drop table SEARCHPROFILE_SPORTTYPES cascade;
drop table SUBDIVISION cascade;
drop table TRANSACTION cascade;
drop table USERACCOUNT cascade;
drop table USERPROFILE cascade;
drop table USERPROFILE_LANGUAGES cascade;
drop table USERS cascade;
drop table VISIT cascade;
drop table VOUCHER_PAYMENT cascade;
drop table WALLETACCOUNT cascade;
drop table ID_SEQUENCES cascade;
create table ADDRESS (ID int8 not null, ZIPCODE varchar(255), STREET varchar(255), HOUSENR varchar(255), CITY varchar(255), COUNTRY varchar(255), GEOLOCATION_ID int8, primary key (ID));
...
create table GEOLOCATION (ID int8 not null, NAME varchar(255), ZIPCODE varchar(255), LATITUDE float8, LONGITUDE float8, POPULATION int4, COUNTRY varchar(255), SUBDIVISION_BIGGEST_ID int8, SUBDIVISION_SMALLEST_ID int8, CONTINENT varchar(255), primary key (ID));
...
create table LIFESTYLE (ID int8 not null, DRINKTYPE varchar(255), SMOKETYPE varchar(255), OCCUPATIONTYPE varchar(255), PROFESSIONTYPE varchar(255), HOMETYPE varchar(255), LIVINGSITUATION varchar(255), PLAYINSTRUMENT bool, SPORTSACTIVITYTYPE varchar(255), HOLIDAYPLANNINGTYPE varchar(255), FITNESSTYPE varchar(255), primary key (ID));
...
create table MEMBERSHIP (ID int8 not null, USERACCOUNT_ID int8, STARTDATE timestamp, ENDDATE timestamp, ACCEPTEDTERMS bool, STATUS varchar(255), PAYMENTTRANSACTION int8, PRODUCT int8, PROMOTION int8, primary key (ID), unique (USERACCOUNT_ID, STARTDATE));
create table MESSAGE (ID int8 not null, MESSAGETYPE varchar(255), MESSAGESTATE_RECEIVER varchar(255), MESSAGESTATE_SENDER varchar(255), TIME_STAMP timestamp, RECEIVER int8, SENDER int8, SUBJECT varchar(255), TEXT varchar(4000), primary key (ID));
...
create table PAYONETRANSACTION (ID int8 not null, CUSTOMERMESSAGE varchar(255), ERRORCODE int4, ERRORMESSAGE varchar(255), MERCHANTTRANSACTIONREFERENCE varchar(255), PARAM varchar(255), PAYONEDEBITORID int4, PAYONEID int8, REDIRECTURL int8, SUBACCOUNTID int4, primary key (ID));
...
create table PROMOTION (ID int8 not null, PROMOTION_TYPE varchar(255), CODE varchar(255), USERACCOUNT int8, PRODUCT int8, VALID_FROM timestamp, VALID_TO timestamp, TIME_STAMP timestamp, primary key (ID));
create table SEARCHPROFILE (ID int8 not null, PARTNERTYPE varchar(255), PROFILE_PICTURE_TYPE varchar(255), MINAGE int4, MAXAGE int4, GEOAREA_ID int8, NUMBER_OF_KIDS_TYPE varchar(255), WANT_MORE_CHILDREN_TYPE varchar(255), PARTNERSHIPTYPE varchar(255), MOTHERLANGUAGE varchar(255), HOUSEHOLDTYPE varchar(255), MINHEIGHTCM int4, MAXHEIGHTCM int4, SMOKETYPE varchar(255), INCOMETYPE varchar(255), OCCUPATIONTYPE varchar(255), primary key (ID));
...
create table SUBDIVISION (ID int8 not null, CODE varchar(255), NAME varchar(255), COUNTRY varchar(255), PARENT_ID int8, primary key (ID), unique (CODE, NAME, COUNTRY));
...
create table USERACCOUNT (ID int8 not null, ROLES varchar(255), LASTLOGIN timestamp, NOTIFICATIONSETTINGS int8 unique, ONLINE bool, PASSWORD varchar(255) not null, PASSWORD_SALT varchar(255), PREFERRED_LANGUAGE varchar(255), PREMIUM_END_DATE timestamp, USERNAME varchar(255), USER_ID int8, primary key (ID));
create table USERPROFILE (ID int8 not null, APPEARANCE int8, BIRTHDATE timestamp, EDUCATION varchar(255), FAMILYSTATUS varchar(255), GEOLOCATION_ID int8, HOUSEHOLDTYPE varchar(255), INCOMETYPE varchar(255), LIFESTYLE int8, MOTHERLANGUAGE varchar(255), MOTTO varchar(255), NUMBEROFKIDS varchar(255), OCCUPATIONTYPE varchar(255), PARTNERTYPE varchar(255), PERSONALVALUES int8, PROFESSION varchar(255), RELIGION varchar(255), WANT_MORE_CHILDREN_TYPE varchar(255), primary key (ID));
create table USERPROFILE_LANGUAGES (USERPROFILE_ID int8 not null, LANGUAGE varchar(255));
create table USERS (ID int8 not null, EMAIL varchar(256) not null, FIRSTNAME varchar(255), LASTNAME varchar(255), ADDRESS int8, SEARCHPROFILE int8, USERPROFILE int8, USERACCOUNT int8, primary key (ID));
