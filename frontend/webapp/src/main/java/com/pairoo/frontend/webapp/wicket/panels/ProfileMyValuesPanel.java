 ...
 */
public class ProfileMyValuesPanel extends BasePanel {

    private static final long serialVersionUID = 1L;
    @SpringBean(name = UserService.BEAN_ID)
    private UserService userService;

    public ProfileMyValuesPanel(final String id, final IModel<User> model) {
        super(id, model);
    }
    ...
    protected void onBeforeRender() {
        ...
        logEnter(ProfileMyValuesPanel.class);
    }
    ...
    protected void onInitialize() {
        ...
        final EditUserProfile3Panel panel = new EditUserProfile3Panel("editUserProfile3Panel",
