 ...
 */
public class RegistrationStep3PageTest extends AbstractWicketTest {
    ...
    public void testRendering() throws ServletException {
        final Page page = new RegistrationStep3Page(new Model<User>(mockUser));
        getTester().startPage(page);
        getTester().assertRenderedPage(RegistrationStep3Page.class);
    }
}
