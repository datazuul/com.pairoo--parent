 ...
 */
public class DeleteProfilePageTest extends AbstractWicketTest {
    ...
    public void testRendering() throws ServletException {
        final Page page = new DeleteProfilePage(new Model<User>(mockUser));
        getTester().startPage(page);
        getTester().assertRenderedPage(DeleteProfilePage.class);
    }
}
