 ...
 */
public class RegistrationStep5PageTest extends AbstractWicketTest {
    ...
    public void testRendering() throws ServletException {
        final Page page = new RegistrationStep5Page(new Model<User>(mockUser));
        getTester().startPage(page);
        getTester().assertRenderedPage(RegistrationStep5Page.class);
    }
}
