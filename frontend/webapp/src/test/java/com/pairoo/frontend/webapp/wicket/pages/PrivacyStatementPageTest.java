...
public class PrivacyStatementPageTest extends AbstractWicketTest {
    ...
    public void testRendering() {
        Page page = new PrivacyStatementPage() {
        ...
        getTester().assertRenderedPage(PrivacyStatementPage.class);
        getTester().dumpPage();
