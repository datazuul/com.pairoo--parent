package com.pairoo.frontend.webapp.admin;
 ...
 * 
 * $ cd com.pairoo--parent/frontend/webapp-admin
 * 
...
public class Start {
	...
	System.setProperty("sysEnv.pairoo.logfilename", "pairoo-admin.log");
	System.setProperty("sysEnv.pairoo.exception.receiver",
		"ralf.eichinger@pairoo.de");
	...
	final NCSARequestLog requestLog = new NCSARequestLog(
		"/tmp/jetty-admin-yyyy_mm_dd.request.log");
	...
	if ("DEMO".equals(System.getProperty("env"))) {
	    final String[] databaseManagerOptions = new String[] { "--url",
		    "jdbc:hsqldb:mem:admin", "--noexit" };
