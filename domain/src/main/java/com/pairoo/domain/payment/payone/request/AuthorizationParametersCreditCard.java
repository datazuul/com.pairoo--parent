 ...
 */
public class AuthorizationParametersCreditCard extends AuthorizationParameters {
    ...
    public AuthorizationParametersCreditCard() {
	super();
	init();
    }
    
    public AuthorizationParametersCreditCard(AuthorizationParameters params) {
	super(params);
	init();
    }
